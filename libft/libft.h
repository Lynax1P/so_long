...
int			ft_isalpha(int c); // English alph
int			ft_isdigit(int c); // Number 
int			ft_isalnum(int c); // Numb and alph
int			ft_isascii(int c); // Ascii 1 0
int			ft_isprint(int c); // Print Numb
